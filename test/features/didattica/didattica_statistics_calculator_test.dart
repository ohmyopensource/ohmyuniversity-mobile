...
import 'package:ohmyuniversity/features/didattica/domain/entities/didattica_exam_course_entity.dart';
import 'package:ohmyuniversity/features/didattica/domain/services/didattica_statistics_calculator.dart';

void main() {
  const calculator = DidatticaStatisticsCalculator();
  final courses = [
    DidatticaExamCourseEntity(
      id: 'passed-laude',
      year: 1,
      semester: 1,
      name: 'Esame con lode',
