...
import 'package:ohmyuniversity/features/academics/presentation/providers/career_provider.dart';
import 'package:ohmyuniversity/features/academics/presentation/views/career_overview_view.dart';
  ...
  test('combines year and status filters', () {
    ...
    expect(
      container
          .read(careerProvider)
          .visibleCourses
          .every((course) => course.courseType == AcademicCourseType.elective),
      isTrue,
    );
