...
import 'package:ohmyuniversity/features/orario_lezioni/data/datasources/timetable_mock_datasource.dart';
import 'package:ohmyuniversity/features/orario_lezioni/data/datasources/timetable_remote_datasource.dart';
import 'package:ohmyuniversity/features/orario_lezioni/data/models/timetable_model.dart';
import 'package:ohmyuniversity/features/orario_lezioni/data/repositories/timetable_repository_impl.dart';
import 'package:ohmyuniversity/features/orario_lezioni/domain/entities/timetable_document_format.dart';
...
void main() {
  ...
  test('filters timetable documents by the active student course', () async {
    ...
    expect(informatica.every((document) => document.title == 'Informatica'), isTrue);
