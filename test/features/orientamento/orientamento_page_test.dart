...
import 'package:ohmyuniversity/features/orientamento/presentation/pages/orientamento_page.dart';
import 'package:ohmyuniversity/features/orientamento/presentation/providers/orientation_providers.dart';
  ...
  testWidgets('opens the guide, shows questions and saves an answer', (
    ...
    await tester.pumpWidget(
      UncontrolledProviderScope(
        container: container,
        child: const MaterialApp(home: OrientamentoPage()),
      ),
    );
    await tester.pump();
    ...
    expect(container.read(toastServiceProvider).last.message, 'Risposta salvata');
