...
import 'package:ohmyuniversity/features/orientamento/data/orientation_static_data.dart';
...
void main() {
  ...
  test('produces a result only after all orientation questions are answered', () {
    final ref = container();
    final controller = ref.read(orientationControllerProvider.notifier);
