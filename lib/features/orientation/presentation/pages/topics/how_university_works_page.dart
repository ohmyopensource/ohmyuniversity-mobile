...
class _ComeFunzionaUniversitaPageState
    extends State<ComeFunzionaUniversitaPage> {
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: _OrientationDots(count: 5, currentIndex: _currentPage),
            ),
          ],
        ),
      ),
...
class _OrientationScrollablePage extends StatelessWidget {
  const _OrientationScrollablePage({required this.title, required this.child});
      ...
      children: [
        ...
        Row(
          children: [
            ...
            SizedBox(width: 18),
            Expanded(
              child: _CityListHighlight(cities: ['Milano', 'Bologna', 'Roma']),
            ),
          ],
        ),
      ],
...
class _CarouselTextBlock extends StatelessWidget {
  const _CarouselTextBlock({required this.title, required this.body});
...
class _OrientationDots extends StatelessWidget {
  const _OrientationDots({required this.count, required this.currentIndex});
