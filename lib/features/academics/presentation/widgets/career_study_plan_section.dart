...
class CareerStudyPlanSection extends ConsumerWidget {
  ...
  List<_CourseGroup> _groupCourses(List<AcademicExamCourseEntity> courses) {
    final byYearAndSemester = <int, Map<int, List<AcademicExamCourseEntity>>>{};
  ...
  List<_SemesterGroup> _semesterGroups(
    Map<int, List<AcademicExamCourseEntity>> bySemester,
  ) {
