...
class _StudyPlanPageState extends ConsumerState<StudyPlanPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final courses = ref.watch(academicExamCoursesProvider);
  ...
  List<AcademicExamCourseEntity> _filterCourses(
    List<AcademicExamCourseEntity> courses,
    ...
    return switch (filter) {
      ...
      StudyPlanFilter.elective =>
        courses
            .where((course) => course.courseType == AcademicCourseType.elective)
            .toList(),
    };
  }

  List<AcademicExamCourseEntity> _coursesForYear(
    List<AcademicExamCourseEntity> courses,
    int year,
  ) {
            ...
            children: [
              ...
              Text(
                ...
                style: theme.textTheme.labelSmall?.copyWith(
                  color: course.courseType == AcademicCourseType.elective
...
extension AcademicCourseTypeLabel on AcademicCourseType {
  String get label {
    return switch (this) {
      AcademicCourseType.mandatory => 'Obbligatorio',
      AcademicCourseType.elective => 'A scelta',
    };
  }
}
