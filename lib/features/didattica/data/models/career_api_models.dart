...
import 'didattica_exam_course_model.dart';

class TranscriptResponseModel {
  const TranscriptResponseModel(this.courses);

  final List<DidatticaExamCourseModel> courses;
  ...
  static DidatticaExamCourseModel _courseFromJson(Map<String, dynamic> json) {
    ...
    return DidatticaExamCourseModel(
      ...
      courseType: typeDescription.toLowerCase().contains('scelta')
          ? DidatticaCourseType.elective
          : DidatticaCourseType.mandatory,
...
class StudyPlanResponseModel {
  ...
  List<DidatticaExamCourseModel> mergeTranscript(
    List<DidatticaExamCourseModel> transcriptCourses,
  ) {
    ...
    final merged = <DidatticaExamCourseModel>[];
