...
class _QuestionsButton extends StatelessWidget {
  const _QuestionsButton({required this.onPressed});
...
class _QuestionIntroCard extends StatelessWidget {
  const _QuestionIntroCard();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.colorInfoLight),
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Leggile con calma, poi rispondi: aggiornano automaticamente il tuo profilo di orientamento.',
                  style: Theme.of(context).textTheme.bodySmall?.copyWith(
                    color: AppColors.colorNeutral600,
                    height: 1.4,
                  ),
