...
class AcademicAverageTrendPoint {
  const AcademicAverageTrendPoint({required this.date, required this.value});

  final DateTime date;
  final double value;
}

class GraduationProjectionTile extends StatelessWidget {
  const GraduationProjectionTile({
    super.key,
    required this.value,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: academicStatisticsCardDecoration(),
      child: Column(
...
class AverageTrendTile extends StatelessWidget {
  const AverageTrendTile({super.key, required this.points});
...
BoxDecoration academicStatisticsCardDecoration() {
